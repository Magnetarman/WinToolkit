...
toolText.7ZipPortableAlreadyPresent = 7-Zip portable already present.
toolText.download7ZipFrom0 = ⬇️ Download 7-Zip from: {0}
toolText.7ZipPortableDownloadedAndVerified = 7-Zip portable downloaded and verified.
toolText.invalidDownloadedFileSize0Bytes = Invalid downloaded file (Size: {0} bytes).
toolText.downloadFailedFrom01 = Download failed from {0}: {1}
toolText.unableToDownload7ZipFromAllSources = Unable to download 7-Zip from all sources.
...
toolText.compressionWith7Zip = 🚀 Compression with 7-Zip.
toolText.compressionCompleted0MbReduction1 = Compression completed: {0} MB (Reduction: {1}%).
toolText.compressionFailedWithExitcode0 = Compression failed with ExitCode: {0}.
...
toolText.extra.invalid7ZipPath0 = Invalid 7-Zip path: {0}
toolText.extra.backupDirectoryNotFound0 = Backup directory not found: {0}
toolText.extra.7ZipArchiveCompression = 7-Zip archive compression
toolText.extra.timeoutReachedDuringCompression = Timeout reached during compression.
